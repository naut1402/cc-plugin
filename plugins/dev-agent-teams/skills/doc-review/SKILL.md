...
- **Trong pipeline**: orchestrator đã nạp rule và truyền "Rule review doc" vào `.dev-team-agent/tasks/<task-id>/project-rules.md`. Đọc phần đó.
...
Đọc `.dev-team-agent/tasks/<task-id>/<doc>.md` toàn bộ.
...
### Bước 4 — Ghi `.dev-team-agent/tasks/<task-id>/<doc>-po.md`
