...
### Bước 1 — Nạp review rules từ project

Dùng skill `read-project-rules` với category `doc-review` — thứ tự tìm kiếm và tiêu chí hợp lệ (phải có đủ phần **kỹ thuật** và phần **trình bày**) được thống nhất tại skill đó.

**Nếu kết quả trả về báo không tìm thấy rules hợp lệ**: thông báo lại cho user nơi đã tìm, lý do không hợp lệ, và dừng xử lý. Không tự bịa rule.
